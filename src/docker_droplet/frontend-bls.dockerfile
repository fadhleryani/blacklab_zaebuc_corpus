...
ARG BLACKLAB_IMAGE_VERSION=4.0.0
...
COPY blacklab-frontend/ .
COPY docker_droplet/data/ .
...
#NOTE blacklab-frontend, NOT corpus-frontend
ARG CONFIG_ROOT=docker_droplet/data/index-configs
